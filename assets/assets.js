...
export const productsDummyData = [
  {
    ...
    description:
      "A 4-week course designed to introduce you to the fundamental poses and principles of yoga. Perfect for building a strong foundation.",
    price: 99.99,
    offerPrice: 79.99,
    image: [
      "/images/yoga.webp",
  ...
  },
  {
    ...
    description:
      "Learn to calm your mind, reduce stress, and live in the present moment with this guided 30-day meditation course.",
    price: 59.99,
    offerPrice: 49.99,
    image: [
  ...
  },
  {
    ...
    description:
      "Challenge your practice with complex sequences, advanced postures, and dynamic transitions in this invigorating Vinyasa course.",
    price: 129.99,
    offerPrice: 109.99,
    image: [
      "/images/adv.jpg",
  ...
  },
  {
    ...
    description:
      "Find peace and emotional balance through a combination of guided meditation, breathing exercises, and cognitive techniques.",
    price: 79.99,
    offerPrice: 69.99,
    image: [
      "/images/stress.webp",
  ...
  },
  {
    ...
    description:
      "Align your energy centers and promote holistic well-being with guided meditations and yoga practices for each chakra.",
    price: 69.99,
    offerPrice: 59.99,
    image: [
      "/images/healing.webp",
  ...
  },
  {
    ...
    description:
      "Unwind and release tension with this gentle, slow-paced yoga course that uses props to support the body in deep relaxation.",
    price: 59.99,
    offerPrice: 49.99,
    image: [
      "/images/restorative.webp",
    ],
    category: "Yoga",
    date: 1738667788883,
    __v: 0,
  },
  {
    ...
    description:
      "A comprehensive self-help program to build lasting habits, overcome procrastination, and achieve your personal goals.",
    price: 149.99,
    offerPrice: 119.99,
    image: [
      "/images/selfdiscipline.jpg",
    ],
    category: "Self-Help",
    date: 1738667977644,
    __v: 0,
  },
  {
    ...
    description:
      "Drift into a restful and rejuvenating sleep with these soothing guided meditations designed to calm the mind and body.",
    price: 39.99,
    offerPrice: 29.99,
    image: [
      "/images/sleepMeditation.jpg",
    ],
    category: "Meditation",
    date: 1738668086331,
    __v: 0,
  },
  {
    ...
    description:
      "Build strength, flexibility, and endurance with this dynamic and athletic style of yoga that will challenge you physically and mentally.",
    price: 89.99,
    offerPrice: 79.99,
    image: [
  ...
  },
  {
    ...
    description:
      "Embark on a journey of self-discovery to uncover your passions, values, and life's purpose with this inspiring course.",
    price: 119.99,
    offerPrice: 99.99,
    image: [
      "/images/purpose.webp",
